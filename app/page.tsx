  ...
  return (
    <div style={{ backgroundColor: '#080808', color: '#FFFFFF', fontFamily: 'Satoshi, sans-serif' }}>
      ...
      <div style={{ padding: '2rem', textAlign: 'center' }}>
        ...
        <h3 style={{ fontWeight: 570, fontSize: '19px' }}>Hi! My name is Sean and I'm a 13 year old tech nerd that had enough imagination to make this sit for no reason :P</h3>
